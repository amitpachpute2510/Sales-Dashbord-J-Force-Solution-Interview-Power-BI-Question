...
SELECT * FROM Clean_Data_table 
--- FOR THIS IMPORT CLEAN DATA IN SQL I USED OBJECT EXPLOVER DASHBORD
-- STEPS -
--RIGHT CLICK ON THE DATABASE THEN GOTO 
--TASK 
--THEN IMPORT FLAT FILE 
--SELECT LOCATION/PATH OF TAHT FILE THEN ENTER THE NAME OF TABLE THEN INSERT
--DATA INSERTED
